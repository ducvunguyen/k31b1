 	...
 	<table>
 		<thead>
 			<tr>
 				...
 				<th>
 					<a href="create.php" title="">Add new</a>
 				</th>
 			</tr>
 		</thead>
 		<tbody>
 			...
 			<tr>
 				...
 				<td>
 					<a href="update.php?productId=<?php echo $pr['ProductID'] ?>" title="">Update</a>
 					<a href="remove.php?productId=<?php echo $pr['ProductID'] ?>" title="">Remove</a>
 				</td>
 			</tr>
 			<?php endforeach ?>
 		</tbody>
